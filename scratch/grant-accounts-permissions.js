...
const newPermissions = [
  {
    collection: 'ji_cuentas_bancarias',
    action: 'read',
    fields: ['*'],
    policy: policyId,
  },
...
async function grantPermissions() {
  try {
    console.log('Granting permissions for ji_cuentas_bancarias in Directus...')
    ...
    console.log('🎉 All bank account permissions granted successfully!')
  } catch (error) {
